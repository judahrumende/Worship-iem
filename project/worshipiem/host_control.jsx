...
function HostControl({ room, go }) {
  ...
  uE(() => {
    ...
    t.on('ping', see);
    t.on('bye', (p) => p && setPlayers(prev => { const c = { ...prev }; delete c[p.id]; return c; }));
  ...
  return (
    <div className="screen">
      ...
      <div className="wrap wide" style={{ paddingTop: 20, paddingBottom: 40, display: 'grid', gridTemplateColumns: 'minmax(0,1.1fr) minmax(0,1fr)', gap: 20, alignItems: 'start' }}>
